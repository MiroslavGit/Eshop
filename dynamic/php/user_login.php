...
<head>
    <link rel="stylesheet" href="../css/user_login.css?<?php echo time(); ?>">
        ...
        <label for="header-toggler-checkbox">
            <div class="header-toggler">
                <div class="header-toggler-circle">
                    <svg class="toggler-arrow-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
            ...
            <div class="signup-content">
                ...
                <div class="signup-input-container">
                    <div class="signup-input">
                        ...
                        <input id="input" type="email" class="signup-input-input input" autocomplete="off"
                            spellcheck="false" placeholder="Email" maxlength="40">
                    </div>
                    <div class="signup-input">
                        <div class="signup-input-icon input-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                        ...
                        <input id="input" type="text" class="signup-input-input input" autocomplete="off"
                    ...
                    <div class="signup-input">
                        ...
                        <input id="password" type="password" class="signup-input-input input" autocomplete="off"
